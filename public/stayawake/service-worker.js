...
const CACHE_NAME = "stay-awake-cache-v2";

// List of URLs to cache during the service worker installation.
const urlsToCache = [
    "/stayawake/", // Cache the root URL (often serves index.html)
    "/stayawake/index.html", // Explicitly cache index.html
    "/stayawake/index.css", // Cache the main stylesheet
    "/stayawake/index.js", // Cache the compiled JavaScript
    "/stayawake/nosleep/nosleep.js", // Cache the NoSleep library
    "/stayawake/favicon/favicon_green.ico", // Cache favicons
    "/stayawake/favicon/favicon_blue.ico",
    "/stayawake/manifest.json", // Cache the Web App Manifest
    "/stayawake/icons/ghost_192x192.png", // Cache PWA icons (Update paths if different)
    "/stayawake/icons/ghost_512x512.png",
